...
$query     = "SELECT * FROM sales WHERE date LIKE :search ORDER BY id DESC LIMIT :start, :limit";
...
if (!empty($sales)) {
  foreach ($sales as $sale) {
    ...
    // $table .= " <td>General</td>";
    $table .= " <td>S/. $sale->subtotal</td>";
    $table .= " <td>$sale->total_items</td>";
    $table .= " <td>";
...
// Paginación
$queryCount     = "SELECT COUNT(*) as total FROM sales WHERE date LIKE :search";
